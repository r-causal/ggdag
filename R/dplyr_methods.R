...
select.tidy_dagitty <- function(.data, ...) {
  .data$data <- dplyr::select(pull_dag_data(.data), ...)
  .data
}
...
filter.tidy_dagitty <- function(.data, ...) {
  .data$data <- dplyr::filter(pull_dag_data(.data), ...)
  .data
}
...
mutate.tidy_dagitty <- function(.data, ...) {
  .data$data <- dplyr::mutate(pull_dag_data(.data), ...)
  .data
}
...
arrange.tidy_dagitty <- function(.data, ...) {
  .data$data <- dplyr::arrange(pull_dag_data(.data), ...)
  .data
}
...
ungroup.tidy_dagitty <- function(x, ...) {
  x$data <- dplyr::ungroup(pull_dag_data(x), ...)
  x
}
...
transmute.tidy_dagitty <- function(.data, ...) {
  .data$data <- dplyr::transmute(pull_dag_data(.data), ...)
  .data
}
...
#' @importFrom dplyr distinct
distinct.tidy_dagitty <- function(.data, ..., .keep_all = FALSE) {
  .data$data <- dplyr::distinct(pull_dag_data(.data), ..., .keep_all = .keep_all)
  .data
}
...
full_join.tidy_dagitty <- function(x, y, by = NULL, copy = FALSE, suffix = c(".x", ".y"), ...) {
  x$data <- dplyr::full_join(pull_dag_data(x), y, by = by, copy = copy, suffix = suffix, ...)
  x
}
...
inner_join.tidy_dagitty <- function(x, y, by = NULL, copy = FALSE, suffix = c(".x", ".y"), ...) {
  x$data <- dplyr::inner_join(pull_dag_data(x), y, by = by, copy = copy, suffix = suffix, ...)
  x
}
...
left_join.tidy_dagitty <- function(x, y, by = NULL, copy = FALSE, suffix = c(".x", ".y"), ...) {
  x$data <- ggdag_left_join(pull_dag_data(x), y, by = by, copy = copy, suffix = suffix, ...)
  x
}
...
right_join.tidy_dagitty <- function(x, y, by = NULL, copy = FALSE, suffix = c(".x", ".y"), ...) {
  x$data <- dplyr::right_join(pull_dag_data(x), y, by = by, copy = copy, suffix = suffix, ...)
  x
}
...
anti_join.tidy_dagitty <- function(x, y, by = NULL, copy = FALSE, ...) {
  x$data <- dplyr::anti_join(pull_dag_data(x), y, by = by, copy = copy, ...)
  x
}
...
semi_join.tidy_dagitty <- function(x, y, by = NULL, copy = FALSE, ...) {
  x$data <- dplyr::semi_join(pull_dag_data(x), y, by = by, copy = copy, ...)
  x
}
...
slice.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::slice(pull_dag_data(.data), ...)
  .data
}
...
select_.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::select_(pull_dag_data(.data), ...)
  .data
}
...
filter_.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::filter_(pull_dag_data(.data), ...)
  .data
}
...
mutate_.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::mutate_(pull_dag_data(.data), ...)
  .data
}
...
summarise_.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::summarise_(pull_dag_data(.data), ...)
  .data
}
...
arrange_.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::arrange_(pull_dag_data(.data), ...)
  .data
}
...
slice_.tidy_dagitty <- function(.data, ..., .dots = list()) {
  .data$data <- dplyr::slice_(pull_dag_data(.data), ...)
  .data
}
