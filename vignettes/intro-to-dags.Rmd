...
ggdag(smoking_ca_dag, use_text = FALSE, use_labels = TRUE)
```
...
ggdag_paths(smoking_ca_dag, use_text = FALSE, use_labels = TRUE, shadow = TRUE)
```
...
```{r}
ggdag_adjustment_set(smoking_ca_dag, use_text = FALSE, use_labels = TRUE, shadow = TRUE)
```
...
ggdag(fever_dag, use_text = FALSE, use_labels = TRUE)
```
...
```{r}
ggdag_dseparated(fever_dag, use_text = FALSE, use_labels = TRUE)
```
