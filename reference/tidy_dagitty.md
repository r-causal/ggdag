...
#>  1 V     -1.50   0.00225 ->        Z1    -0.513 -1.01 
#>  2 V     -1.50   0.00225 ->        Z2    -0.500  1.01 
#>  3 W1     0.314 -0.471   ->        X      0.931 -0.595
#>  4 W1     0.314 -0.471   ->        Y      0.939  0.579
#>  5 W1     0.314 -0.471   ->        Z1    -0.513 -1.01 
#>  6 W1     0.314 -0.471   <->       W2     0.326  0.478
#>  7 W2     0.326  0.478   ->        X      0.931 -0.595
#>  8 W2     0.326  0.478   ->        Y      0.939  0.579
#>  9 W2     0.326  0.478   ->        Z2    -0.500  1.01 
#> 10 X      0.931 -0.595   ->        Y      0.939  0.579
#> 11 Y      0.939  0.579   NA        NA    NA     NA    
#> 12 Z1    -0.513 -1.01    ->        X      0.931 -0.595
#> 13 Z2    -0.500  1.01    ->        Y      0.939  0.579
#> #
