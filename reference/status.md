...
`node_status` tags variable status and `ggdag_status` plots all variable
statuses.
...
#> 3 x     -5.01e- 1 -0.289 ->        y      5.15e-11  0.579 exposure
#> 4 y      5.15e-11  0.579 ->        l      5.01e- 1 -0.289 outcome 
#> #
