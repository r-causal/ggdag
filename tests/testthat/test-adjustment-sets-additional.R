...
test_that("dag_adjustment_sets handles edge cases", {
  ...
  result_simple <- dag_adjustment_sets(dag_simple, exposure = "x", outcome = "y")
  ...
  result_collider <- dag_adjustment_sets(dag_collider, exposure = "x", outcome = "y")
...
test_that("ggdag_adjustment_set with effect parameter", {
  ...
  p_direct <- ggdag_adjustment_set(dag, exposure = "x", outcome = "y", effect = "direct")
...
test_that("dag_adjustment_sets with different adjustment types", {
  ...
  # Test type = "all"
  all_sets <- dag_adjustment_sets(dag, exposure = "x", outcome = "y", type = "all")
  ...
  # Test type = "canonical"
  canonical_sets <- dag_adjustment_sets(dag, exposure = "x", outcome = "y", type = "canonical")
...
test_that("is_collider and is_downstream_collider work correctly", {
  ...
  expect_error(is_downstream_collider(tidy_dag, "non_existent"), "not a variable")
})
